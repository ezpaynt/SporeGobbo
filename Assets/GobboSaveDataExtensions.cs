...
public static class GobboUnitLegacyCloneExtensions
{
    public static GobboUnitSaveData Clone(this GobboUnitSaveData data)
    {
        return data != null ? data.CloneUnit() : new GobboUnitSaveData();
    }
}
